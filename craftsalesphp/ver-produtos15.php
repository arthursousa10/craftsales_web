...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/banner-2.png" alt="" width="" height="">
                        ...
                        <div class="col-2">
                            ...
                            <form action="" method="post">
                                ...
                                <br>
                                 ...
                                 <div>
                                <button class="btn"onclick="adicionarAoCarrinho('Caneca exclusiva',  15.00)">Adicionar ao Carrinho</button>
                                </div>
                            ...
                            <h3>Descrição:</h3>
                            <br>
                            <p>Caneca personalizada Craft Sales.</p>
                        </div>
