...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/produto-11.jpg" alt="" width="" height="">

                        </div>

                        <div class="col-2">
                            <h1>Compre com desconto</h1>
                            <h4>Pendrive SanDisk Cruzer Blade 64GB 2.0
                                <br>
                                <br>
                            ...
                            <h3>Descrição:</h3>
                            <br>
                            <p>Pendrive SanDisk Cruzer Blade 64GB 2.0: Um pendrive da SanDisk com capacidade de 64GB e conexão USB 2.0, ideal para armazenamento portátil de dados.</p>
                        </div>
