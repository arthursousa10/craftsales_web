...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/produto-9.jpg" alt="" width="" height="">

                        </div>

                        <div class="col-2">
                            <h1>Compre com desconto</h1>
                            <h4>Headset over-ear gamer sem fio HyperX
                                <br>
                                <br>
                            R$ 227,90 </h4>
                            <form action="" method="post">
                                ...
                                <br>
                                <div>
                                <button class="btn"onclick="adicionarAoCarrinho('Headset over-ear gamer sem fio HyperX', 227.90  )">Adicionar ao Carrinho</button>
                                </div>
                            ...
                            <h3>Descrição:</h3>
                            <br>
                            <p>Headset over-ear gamer sem fio HyperX Cloud Stinger Core HX-HSCSC2: Um headset gamer sem fio da HyperX, com design over-ear para conforto prolongado, áudio de alta qualidade e microfone integrado.
