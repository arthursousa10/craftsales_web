...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/produto-4.jpg" alt="" width="" height="">

                        </div>

                        <div class="col-2">
                            <h1>Compre com desconto</h1>
                            <h4>Mouse sem fio Logitech M170 com bateria longa
                                <br>
                                <br>
                            R$ 57,90 </h4>
                            <form action="" method="post">
                                ...
                                <br>
                                   ...
                                   <div>
                                <button class="btn" onclick="adicionarAoCarrinho('Mouse sem fio Logitech M170 com bateria longa', 57.90 )">Adicionar ao Carrinho</button>
                                </div>
                            </form>
                            <br>
                            ...
                            <h3>Descrição:</h3>
                            <br>
                            <p>Mouse sem fio Logitech M170 com bateria longa: Um mouse sem fio simples da Logitech, com longa duração de bateria e design confortável para uso diário.
