...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/produto-8.jpg" alt="" width="" height="">

                        </div>

                        <div class="col-2">
                            <h1>Compre com desconto</h1>
                            <h4>Um carregador portátil da Redmi com capacidade de 20000mAh
                                <br>
                                <br>
                            ...
                            <form action="" method="post">
                                ...
                                <br>
                                <div>
                                <button class="btn" onclick="adicionarAoCarrinho('Um carregador portátil da Redmi com capacidade de 20000mAh', 217.90  )">Adicionar ao Carrinho</button>
                                </div>
                            ...
                            <h3>Descrição:</h3>
                            <br>
                            <p>Um carregador portátil da Redmi com capacidade de 20000mAh, permitindo carregar dispositivos móveis enquanto estiver em movimento.</p>
                        </div>
