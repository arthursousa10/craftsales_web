...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/produto-7.jpg" alt="" width="" height="">
                        ...
                        <div class="col-2">
                            ...
                            <h4>Suporte Para Notebook Regulável Metal Cromado Reliza
                                <br>
                                <br>
                            R$ 50,00 </h4>
                            <form action="" method="post">
                                ...
                                <br>
                                 <div>
                                <button class="btn" onclick="adicionarAoCarrinho('Suporte Para Notebook Regulável Metal Cromado Reliza', 50.00  )">Adicionar ao Carrinho</button>
                                </div>
                            ...
                            <h3>Descrição:</h3>
                            <br>
                            <p> Suporte Para Notebook Regulável Metal Cromado Reliza: Um suporte para notebook ajustável em altura, feito de metal cromado, para melhorar a ergonomia e a dissipação de calor do seu laptop.
