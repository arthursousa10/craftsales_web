...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/produto-5.jpg" alt="" width="" height="">

                        </div>

                        <div class="col-2">
                            <h1>Compre com desconto</h1>
                            <h4>Mouse Com Fio Wave
                                <br>
                               <br>
                            R$ 27,90 </h4>
                            <form action="" method="post">
                                ...
                                <br>
                               <div>
                                <button class="btn"onclick="adicionarAoCarrinho('Mouse Com Fio Wave', 27.90 )">Adicionar ao Carrinho</button>
                                </div>
                            ...
                            <h3>Descrição:</h3>
                            <br>
                            <p>Mouse Com Fio Wave Conexão USB 1200dpi Cabo de 130cm 3 Botões Textura Emborrachada: Um mouse com fio com conexão USB, 1200dpi de resolução, cabo de 130cm e textura emborrachada para melhor aderência.
