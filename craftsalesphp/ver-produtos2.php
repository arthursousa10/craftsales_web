...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/produto-3.jpg" alt="" width="" height="">

                        </div>

                        <div class="col-2">
                            <h1>Compre com desconto</h1>
                            <h4>Notebook Acer Nitro 5
                                <br>
                                <br>
                            R$ 4.000,00 </h4>
                            <form action="" method="post">
                                ...
                                <div>
                                <button class="btn" onclick="adicionarAoCarrinho('Notebook Acer Nitro 5', 4500.00 )">Adicionar ao Carrinho</button>
                                </div>
                            </form>
                            <br>
                            ...
                            <h3>Descrição:</h3>
                            <br>
                            <p>Notebook Acer Nitro 5 AN515-58-54UH Ci5 12ª Gen Windows 11 Home 8GB 512GB RTX 3050 15.6” Full HD: Um laptop gamer da Acer da série Nitro 5, com processador Core i5 de 12ª geração, 8GB de RAM, um SSD de 512GB, uma placa de vídeo RTX 3050 e uma tela Full HD de 15,6 polegadas, projetado para jogos de alta performance.</p>
                        </div>
...
function adicionarAoCarrinho(name, price) {
    const pedido = {
        nome: name,
        preco: price.toFixed(2), // Arredonda o preço para duas casas decimais e converte para string
    };
