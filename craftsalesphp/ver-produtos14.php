...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/produto-12.jpg" alt="" width="" height="">

                        </div>

                        <div class="col-2">
                            <h1>Compre com desconto</h1>
                            <h4>REDRAGON-RGB USB Wired Gaming Mouse: Um mouse para jogos com fio da Redragon
                                <br>
                                <br>
                            R$ 349,00 </h4>
                            <form action="" method="post">
                                ...
                                <br>
                                 ...
                                 <div>
                                <button class="btn" onclick="adicionarAoCarrinho('Fon2xP2, REDRAGON-RGB USB Wired Gaming Mouse: Um mouse para jogos com fio da Redragon',  349.00)">Adicionar ao Carrinho</button>
                                </div>
                            </form>
                            <br>
                            ...
                            <h3>Descrição:</h3>
                            <br>
                            <p>REDRAGON-RGB USB Wired Gaming Mouse: Um mouse para jogos com fio da Redragon, projetado para oferecer desempenho excepcional durante sessões de jogos intensas. Apresenta iluminação RGB personalizável para combinar com o estilo do seu setup de jogos e conectividade USB para uma resposta rápida e precisa.</p>
                        </div>
