...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/produto-1.jpg" alt="" width="" height="">

                        </div>

                        <div class="col-2">
                            <h1>Compre com desconto</h1>
                            <h4>    Apple Macbook Air Processador M1 - 8GB - 256GB SSD
                                <br>
                                <br>
                                R$ 6557,00 
                                 </h4>
                                ...
                                <div>
                                 <button class="btn" onclick="adicionarAoCarrinho('Apple Macbook Air', 6557.00)">Adicionar ao Carrinho</button>
                                </div>
                            <br>

                            <h3>Descrição:</h3>
                            <br>
                            <p>Apple Macbook Air Processador M1 - 8GB - 256GB SSD - Tela de 13.3": Um laptop leve e poderoso da Apple, equipado com o revolucionário processador M1, oferecendo desempenho rápido e eficiente, junto com um SSD de 256GB e uma tela de alta resolução de 13.3 polegadas.</p>
                        </div>
