...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/produto-10.jpg" alt="" width="" height="">
                        ...
                        <div class="col-2">
                            ...
                            <form action="" method="post">
                                ...
                                <br>
                                 ...
                                 <div>
                                <button class="btn"onclick="adicionarAoCarrinho('Mouse Pad Glorious Large', 95.90  )">Adicionar ao Carrinho</button>
                                </div>
                            </form>
                            <br>
                            ...
                            <h3>Descrição:</h3>
                            <br>
                            <p>Mouse Pad Glorious Large - 11 X 13: Um mouse pad grande da marca Glorious, oferecendo uma superfície suave e de baixo atrito para movimentos precisos do mouse.
