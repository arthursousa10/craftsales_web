            ...
            <div class="col-2">
                <img src="assets/img/produto-12.jpg" alt="" width="" height="">
                        ...
                        <div class="col-2">
                            ...
                            <h4>Notebook Gigabyte Aorus 17 Xe4, I7-12700h, RTX3070ti, 16GB
                                <br>
                            <br>
                            R$ 1.649 </h4>
                            <form action="" method="post">
                                ...
                                <div>
                                <button class="btn"onclick="adicionarAoCarrinho('Notebook Gigabyte Aorus 17 Xe4, I7-12700h, RTX3070ti, 16GB', 1.649 )">Adicionar ao Carrinho</button>
                                </div>
                            ...
                            <h3>Descrição:</h3>
                            <br>
                            <p>Notebook Gigabyte Aorus 17 Xe4, I7-12700h, RTX3070ti, 16GB: Um laptop de alta performance da Gigabyte da série Aorus, equipado com processador Core i7-12700h, placa de vídeo RTX3070ti, 16GB de RAM e projetado para jogos e tarefas intensivas.</p>
                        </div>
