...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/produto-2.jpg" alt="" width="" height="">
                        ...
                        <div class="col-2">
                            ...
                            <h4> Notebook Asus Vivobook Go Core I3 N305 4gb 256ssd 15,6 Fhd
                               <br>
                               <br>
                            R$ 1.998,00 </h4>
                            <form action="" method="post">
                                ...
                                <br>
                                  ...
                                  <div>
                                <button class = "btn" onclick="adicionarAoCarrinho('Notebook Asus Vivobook', 1998.00)">Adicionar ao Carrinho</button>
                                </div>
                            </form>
                            <br>
                            ...
                            <h3>Descrição:</h3>
                            <br>
                            <p>Notebook Asus Vivobook Go Core i3 N305 4GB 256SSD 15,6 FHD: Um notebook da Asus da linha Vivobook Go, com processador Core i3, 4GB de RAM, um SSD de 256GB e uma tela Full HD de 15,6 polegadas, ideal para uso diário e tarefas básicas.</p>
                        </div>
