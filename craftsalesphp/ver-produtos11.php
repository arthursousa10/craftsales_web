            ...
            <div class="navbar">
                ...
                <nav>
                    <ul id="MenuItens">
                        ...
                        <li><a href="empresa" title="">Empresa</a></li>
                        <li><a href="contatos" title="">Contatos</a></li>
            ...
            <div class="col-2">
                <img src="assets/img/produto-12.jpg" alt="" width="" height="">
                        ...
                        <div class="col-2">
                            ...
                            <h4>Headset gamer G533 7.1 Surround Drivers Pro-G - Logitech
                                <br>
                                <br>
                            ...
                            <form action="" method="post">
                                ...
                                <div>
                                <button class="btn"onclick="adicionarAoCarrinho('Pendrive SanDisk Cruzer Blade 64GB 2.0', 27.90  )">Adicionar ao Carrinho</button>
                                </div>
                            ...
                            <h3>Descrição:</h3>
                            <br>
                            <p>Headset gamer G533 7.1 Surround Drivers Pro-G - Logitech: Um headset gamer da Logitech, com áudio surround 7.1, drivers Pro-G para qualidade de som superior e conectividade sem fio avançada.
